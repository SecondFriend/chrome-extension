...
Backbone.sync = function(method, model, options) {
  if((model.localStorage || (model.collection &&
model.collection.localStorage)) && (model.urlRoot || (model.collection
&& model.collection.url))){
        if(options.location === "local") Backbone.localSync(method, model,
options);
        else Backbone.ajaxSync(method, model, options);
     } else {
       if(model.localStorage || (model.collection &&
